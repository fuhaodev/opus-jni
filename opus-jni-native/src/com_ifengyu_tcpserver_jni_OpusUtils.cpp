...
JNIEXPORT jlong JNICALL Java_com_ifengyu_tcpserver_jni_OpusUtils_createEncoder
        (JNIEnv *env, jobject thiz, jint sampleRateInHz, jint channelConfig, jint bitrate, jint complexity) {
    int error;
...
JNIEXPORT jlong JNICALL Java_com_ifengyu_tcpserver_jni_OpusUtils_createDecoder
    ...
    // if (pOpusDec) {
    //     opus_decoder_ctl(pOpusDec, OPUS_SET_VBR(0)); //0:CBR, 1:VBR
    // }
